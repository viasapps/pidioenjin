...
class UserController extends BaseController {
    ...
    public function create()
    {
        ...
        $this->theme->bind('active', 'register');

        return $this->theme->scope('user.register')->render();
    ...
    public function confirm( $code )
    {
        if ( Confide::confirm( $code ) )
        {
            ...
            $event = Event::fire('user.confirm', array($user));
    ...
    public function forgot_password()
    {
        ...
        return $this->theme->scope('user.forgot_password')->render();
    ...
    public function reset_password( $token )
    {
        ...
        return $this->theme->scope('user.reset_password', $data)->render();
