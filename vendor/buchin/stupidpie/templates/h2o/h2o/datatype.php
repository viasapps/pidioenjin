...
class Evaluator {
    public static function gt($l, $r) { return $l > $r; }
    public static function ge($l, $r) { return $l >= $r; }

    public static function lt($l, $r) { return $l < $r; }
    public static function le($l, $r) { return $l <= $r; }

    public static function eq($l, $r) { return $l == $r; }
    public static function ne($l, $r) { return $l != $r; }

    public static function not_($bool) { return !$bool; }
    public static function and_($l, $r) { return ($l && $r); }
    public static function or_($l, $r) { return ($l && $r); }
